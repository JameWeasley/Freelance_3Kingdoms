  ...
  return (
    <>
      ...
      <div className="container">
        ...
        <div className="pay-body" style={{ width: '50%', margin: '0 auto', border: 'none', borderRadius: '10px', padding: '10px', background: 'linear-gradient(rgb(0 0 0 / 36%), rgba(237, 237, 237, 0.51))' }}>
